                        ...
                        <div class="breadcrumb_iner_item">
                            ...
                            <div class="form" style="margin-top:90px;">
                                <form action="" method="post" role="form" class="contactForm" autocomplete="off">
                                   ...
                                   <b>Hobbies: </b>
                                   <input id="playing" type="checkbox" name="hobbies" value="playing"><label for="playing"><font color="white"/> playing</label>
                                   <input id="reading" type="checkbox" name="hobbies" value="reading"><label for="reading"><font color="white"/>  reading</label>
                                   <input id="traveling" type="checkbox" name="hobbies" value="traveling"><label for="traveling"><font color="white"/>  traveling <br></label>
                                    ...
                                    <div class="text-center"><button name="submit" type="submit" class="btn btn-success">Submit</button></div>
                                </form>
